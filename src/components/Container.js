...
const Products = () => (<Container className="bg-yellow-900">
  <MainContainer>
    ...
    <div className="flex flex-wrap py-10">
      <div className="w-1/2">
        <img src="https://colorlib.com/preview/theme/coffee/img/r1.png" alt="" />
      ...
      <div className="w-1/2">
        <img src="https://colorlib.com/preview/theme/coffee/img/r2.png" alt="" />
        <div className="flex py-6">
          <Subtitle className="white uppercase font-bold">
            lorem ipusm
            </Subtitle>
    ...
    <div>
      <CountUp start={0} end={2563} delay /> {1000} duration={10}  />
      </div>
  </MainContainer>
</Container>);
